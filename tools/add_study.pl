...
print $query->start_multipart_form(-action=>'insert_study.pl', -name=>'addstudyForm', -onSubmit=>'return checkaddstudyForm(this)');

print "<TABLE WIDTH=\"700\" BORDER=\"1\" CELLPADDING=\"2\" CELLSPACING=\"0\">\n";
print "<TR>\n<TD CLASS=\"title\" VALIGN=\"MIDDLE\" ALIGN=\"CENTER\" COLSPAN=\"2\">";
print "<B>BRI New Study Form</B>\n";
print "</TD></TR>\n";
